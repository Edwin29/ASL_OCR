...
old_root = Path(r"C:\ASL_OCR_INTEGRATION_RUNTIME\demo-20260905\hardware-integration\h1-20260907-231944")
...
shutil.copytree(old_root / "config", run_root / "config")
...
if old_posix not in text:
    raise SystemExit("expected preserved H1 state root was not present in copied config")
...
manifest = {
    ...
    "production_entrypoint": "python -m asl_device",
