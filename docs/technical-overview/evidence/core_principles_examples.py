...
math=[]
for raw in [r'\frac{1}{2}', r'x+\unsupported', r'\frac{']:
...
blocks=[block('display_formula',r'\frac{1}{2}',3),
        block('text','① 1 ② 2 ③ 3 ④ 4 ⑤ 5',4),
        block('text','[26008-0011]',1),
        block('text','다음 분수의 분모를 고르시오.',2)]
class FakeVl:
...
result={'scope':'controlled text/VL-result/raw-pair fixtures; no OCR inference or physical output',
