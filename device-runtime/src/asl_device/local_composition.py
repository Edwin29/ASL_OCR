...
def _default_scanner_factory(config: ScannerHostConfig) -> BookScannerEngineFactory:
    ...
    return LocalBookScannerEngineFactory(
        LocalScannerRuntimeConfig(
            ...
            camera_crop_normalized=config.camera_crop_normalized,
            ...
            camera_snapshot_url=config.camera_snapshot_url,
            camera_snapshot_username=config.camera_snapshot_username,
            camera_snapshot_password_file=config.camera_snapshot_password_file,
            camera_snapshot_tls_ca_file=config.camera_snapshot_tls_ca_file,
            camera_snapshot_allow_insecure_tls=config.camera_snapshot_allow_insecure_tls,
            camera_snapshot_timeout_seconds=config.camera_snapshot_timeout_seconds,
            camera_snapshot_max_response_bytes=config.camera_snapshot_max_response_bytes,
            camera_snapshot_min_width=config.camera_snapshot_min_width,
            camera_snapshot_min_height=config.camera_snapshot_min_height,
            camera_snapshot_landscape_rotation=config.camera_snapshot_landscape_rotation,
            camera_snapshot_portrait_rotation=config.camera_snapshot_portrait_rotation,
