...
class NavigationResult:
    ...
    state with the same generation). `boundary_message` is the announcement
    text for boundary conditions ("첫 행입니다" etc.); it is None when the
    command moved focus normally.
    """
