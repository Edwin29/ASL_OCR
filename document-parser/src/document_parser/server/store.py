...
from document_parser.accessibility import NavigationState
...
class SessionStore:
    ...
    def get_or_create_session(
        self, session_id: str, book_id: str, initial_state: NavigationState | None = None
    ) -> DatapackSession:
        ...
        session = DatapackSession(datapack, initial_state=initial_state)
